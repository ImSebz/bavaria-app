...
import './locationItemCali.css';
import LocationPopupCali from '../LocationPopupCali/locationPopupCali';

const LocationItemCali = ({ id, name, description, image, image_carousel, subtitle, url_reserva, promo, carta, marca, marca_logo, marker, dress_code, schedule }) => {
...
export default memo(LocationItemCali);