...
import './locationPopupBarranquilla.css';
...
const LocationPopupBarranquilla = ({ isOpen, onRequestClose, location }) => {
...
export default LocationPopupBarranquilla;